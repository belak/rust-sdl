...
fn test_color() {
    ...
    //assert_eq!(target, (255, 0, 255, 255).as_u32());
    //assert_eq!(target, 0xFF00FFFFu32.as_u32());
...
impl ToColor for u32 {
    #[inline]
    fn as_rgba(&self) -> (u8, u8, u8, u8) {
        u32::to_be_bytes(*self).into_iter().collect_tuple().unwrap()
    }
...
impl ToColor for isize {
    #[inline]
    fn as_rgba(&self) -> (u8, u8, u8, u8) {
        u32::to_be_bytes(self.as_u32()).into_iter().collect_tuple().unwrap()
    }
...
pub trait DrawRenderer {
    fn pixel<C: ToColor>(&self, x: i16, y: i16, color: C) -> sdl::Result<()>;
    fn hline<C: ToColor>(&self, x1: i16, x2: i16, y: i16, color: C) -> sdl::Result<()>;
    fn vline<C: ToColor>(&self, x: i16, y1: i16, y2: i16, color: C) -> sdl::Result<()>;
    ...
    fn box_<C: ToColor>(&self, x1: i16, y1: i16, x2: i16, y2: i16, color: C) -> sdl::Result<()>;
    ...
    fn line<C: ToColor>(&self, x1: i16, y1: i16, x2: i16, y2: i16, color: C) -> sdl::Result<()>;
    fn aa_line<C: ToColor>(&self, x1: i16, y1: i16, x2: i16, y2: i16, color: C) -> sdl::Result<()>;
    ...
    fn circle<C: ToColor>(&self, x: i16, y: i16, rad: i16, color: C) -> sdl::Result<()>;
    fn aa_circle<C: ToColor>(&self, x: i16, y: i16, rad: i16, color: C) -> sdl::Result<()>;
    fn filled_circle<C: ToColor>(&self, x: i16, y: i16, rad: i16, color: C) -> sdl::Result<()>;
    fn arc<C: ToColor>(
        &self,
        x: i16,
        y: i16,
    ...
    fn ellipse<C: ToColor>(&self, x: i16, y: i16, rx: i16, ry: i16, color: C) -> sdl::Result<()>;
    fn aa_ellipse<C: ToColor>(&self, x: i16, y: i16, rx: i16, ry: i16, color: C)
        -> sdl::Result<()>;
    ...
    fn polygon<C: ToColor>(&self, vx: &[i16], vy: &[i16], color: C) -> sdl::Result<()>;
    fn aa_polygon<C: ToColor>(&self, vx: &[i16], vy: &[i16], color: C) -> sdl::Result<()>;
    fn filled_polygon<C: ToColor>(&self, vx: &[i16], vy: &[i16], color: C) -> sdl::Result<()>;
    ...
    fn bezier<C: ToColor>(&self, vx: &[i16], vy: &[i16], s: i32, color: C) -> sdl::Result<()>;
    fn character<C: ToColor>(&self, x: i16, y: i16, c: char, color: C) -> sdl::Result<()>;
    fn string<C: ToColor>(&self, x: i16, y: i16, s: &str, color: C) -> sdl::Result<()>;
}
