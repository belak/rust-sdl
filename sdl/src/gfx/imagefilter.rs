...
pub fn add(src1: CVec<u8>, src2: CVec<u8>) -> sdl::Result<CVec<u8>> {
...
pub fn mean(src1: CVec<u8>, src2: CVec<u8>) -> sdl::Result<CVec<u8>> {
    assert_eq!(src1.len(), src2.len());
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn sub(src1: CVec<u8>, src2: CVec<u8>) -> sdl::Result<CVec<u8>> {
    assert_eq!(src1.len(), src2.len());
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn abs_diff(src1: CVec<u8>, src2: CVec<u8>) -> sdl::Result<CVec<u8>> {
    assert_eq!(src1.len(), src2.len());
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn mult(src1: CVec<u8>, src2: CVec<u8>) -> sdl::Result<CVec<u8>> {
    assert_eq!(src1.len(), src2.len());
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn mult_nor(src1: CVec<u8>, src2: CVec<u8>) -> sdl::Result<CVec<u8>> {
    assert_eq!(src1.len(), src2.len());
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn mult_div_by2(src1: CVec<u8>, src2: CVec<u8>) -> sdl::Result<CVec<u8>> {
    assert_eq!(src1.len(), src2.len());
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn mult_div_by4(src1: CVec<u8>, src2: CVec<u8>) -> sdl::Result<CVec<u8>> {
    assert_eq!(src1.len(), src2.len());
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn bit_and(src1: CVec<u8>, src2: CVec<u8>) -> sdl::Result<CVec<u8>> {
    assert_eq!(src1.len(), src2.len());
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn bit_or(src1: CVec<u8>, src2: CVec<u8>) -> sdl::Result<CVec<u8>> {
    assert_eq!(src1.len(), src2.len());
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn div(src1: CVec<u8>, src2: CVec<u8>) -> sdl::Result<CVec<u8>> {
    assert_eq!(src1.len(), src2.len());
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn bit_negation(src1: CVec<u8>) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn add_byte(src1: CVec<u8>, c: u8) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn add_uint(src1: CVec<u8>, c: u32) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn add_byte_to_half(src1: CVec<u8>, c: u8) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn sub_byte(src1: CVec<u8>, c: u8) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn sub_uint(src1: CVec<u8>, c: u32) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn shift_right(src1: CVec<u8>, n: u8) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn shift_right_uint(src1: CVec<u8>, n: u8) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn mult_by_byte(src1: CVec<u8>, c: u8) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn shift_right_and_mult_by_byte(src1: CVec<u8>, n: u8, c: u8) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn shift_left_byte(src1: CVec<u8>, n: u8) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn shift_left_uint(src1: CVec<u8>, n: u8) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn shift_left(src1: CVec<u8>, n: u8) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn binarize_using_threshold(src1: CVec<u8>, t: u8) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
...
pub fn clip_to_range(src1: CVec<u8>, tmin: u8, tmax: u8) -> sdl::Result<CVec<u8>> {
    let size = src1.len();
    let dest = cvec_with_size(size);
    let ret = unsafe {
